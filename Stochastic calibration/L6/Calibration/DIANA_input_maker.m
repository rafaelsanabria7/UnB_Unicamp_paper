...
specific_lines = [35200 35205 35206 35210 35211 35268];
...
B{specific_output(1)} = cell2mat(strcat({'    FILE  L6_'},num2str(j),'_FORCE'));
B{specific_output(2)} = cell2mat(strcat({'    FILE  L6_'},num2str(j),'_DISP'));
B{specific_output(3)} = cell2mat(strcat({'    FILE  L6_'},num2str(j),'_FORCE'));
B{specific_output(4)} = cell2mat(strcat({'    FILE  L6_'},num2str(j),'_DISP'));
B{specific_output(5)} = cell2mat(strcat({'    FILE  L6_'},num2str(j),'_FORCE'));
B{specific_output(6)} = cell2mat(strcat({'    FILE  L6_'},num2str(j),'_DISP'));
