...
%LHS for punching shear model calibration 25-06-2022
%Slab L1 (Albuquerque,2012)
%====================================================================================================%
%                                              LHS                                                   %
%                                                                                                    %
...
mx_Ec=0.9*21500*((mx_fc/10)^(1/3));
vx_Ec=0.15;
sigx_Ec=mx_Ec*vx_Ec;

%Tensile Strength, fct Mpa
mx_fct= 3.06; %2.12*log(1 + 0.1*mx_fc);%0.3*((mx_fc - sigx_fc)^(2/3));
vx_fct= 0.16;
sigx_fct=mx_fct*vx_fct;

%Fracture of Energy , Gf 
mx_Gf= 73*((mx_fc)^0.18); %/sqrt(2);
vx_Gf=0.15;
sigx_Gf=mx_Gf*vx_Gf;
