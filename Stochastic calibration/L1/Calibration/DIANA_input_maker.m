...
specific_lines = [35190 35195 35196 35200 35201 35258];
...
% capture specific lines
specific_output = [108 130 277 299 371 393];

% replacing output names
B{specific_output(1)} = cell2mat(strcat({'    FILE  L1_'},num2str(j),'_DISP'));
B{specific_output(2)} = cell2mat(strcat({'    FILE  L1_'},num2str(j),'_FORCE'));
B{specific_output(3)} = cell2mat(strcat({'    FILE  L1_'},num2str(j),'_DISP'));
B{specific_output(4)} = cell2mat(strcat({'    FILE  L1_'},num2str(j),'_FORCE'));
B{specific_output(5)} = cell2mat(strcat({'    FILE  L1_'},num2str(j),'_DISP'));
B{specific_output(6)} = cell2mat(strcat({'    FILE  L1_'},num2str(j),'_FORCE'));
